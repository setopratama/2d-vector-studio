// src/components/CostEstimationCard.tsx
...
export const CostEstimationCard: React.FC<CostEstimationCardProps> = ({
  ...
  return (
    <div className="bg-white border border-stone-200 shadow-sm p-5 sm:p-6 transition-all">
      {/* Card Header */}
          ...
          <div className="space-y-2 font-mono">
            <div className="flex justify-between items-center text-stone-600">
              ...
              <span className="font-semibold text-stone-900">
                ~{Math.max(0, promptEstimate.estimatedInputTokens - PRICING_CONFIG.SYSTEM_PROMPT_BASE_TOKENS)} tokens
              </span>
            </div>

            <div className="flex justify-between items-center text-stone-600">
              <span>• System Prompt 2D Vector Template:</span>
              <span className="text-stone-700">+{PRICING_CONFIG.SYSTEM_PROMPT_BASE_TOKENS} tokens</span>
            </div>
            ...
            <div className="flex justify-between items-center text-stone-600 pt-1">
              <span>• Target Output ({safeBatch} variasi × ~65 tok):</span>
              <span className="font-semibold text-stone-900">
        ...
        <div className="space-y-3 bg-stone-50 border border-stone-200 p-4 flex flex-col justify-between">
          <div>
            <div className="text-[10px] uppercase font-bold tracking-wider text-stone-500 mb-2">
              Estimasi Biaya Tahap 1 ({safeBatch} Variasi Prompt)
            </div>
      ...
      <div className="mt-5 pt-4 border-t border-stone-200 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
